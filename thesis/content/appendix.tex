...
\begin{equation*}
	N(t) \kern+0.4pt =
	N_0 \exp \Bigl( \raisebox{-0.25ex}{\(-\frac{\raisebox{-0.5ex}{$t$}}{\raisebox{1.0ex}{$\tau \kern+1.0pt$}}\)} \kern+0.5pt \Bigr)
\end{equation*}
...
\begin{equation*}
	P(t) = 1 -
	\kern+1.0pt \exp \Bigl( \raisebox{-0.25ex}{\(-\frac{\raisebox{-0.5ex}{$t$}}{\raisebox{1.0ex}{$\tau \kern+1.0pt$}}\)} \kern+0.5pt \Bigr)
\end{equation*}
before a time $t$ has passed.
