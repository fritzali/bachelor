...
\begin{equation*}
	L = \frac{2\mu^2 \omega^4 \sin^2 \kern-2.5pt \raisebox{0.2ex}{$\chi$}}{3c^3}
\end{equation*}
is the exact expression for radiant power, derived by many standard sources like \cite{Jackson_1999} as well. 
