...
of observing any final state $h$ originating from a $c$ quark is encoded in a \emph{Fragmentation Function}
...
\abbrev{FF} for the constituents of hadrons. By fitting to existing data or perturbative results, models can extrapolate to
...
\end{equation}
with parameters in table \ref{tab:charm-hadrons} from $\kern+0.5pt e^+e^- \kern-0.8pt$ data as the charm hadron \abbrev{FF} used
