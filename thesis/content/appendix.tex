...
To find decay spectra of charmed hadrons, the same appraoch as in \cite{Carpio_2020} is used by assuming an effective
energy distribution from three body approximations.
