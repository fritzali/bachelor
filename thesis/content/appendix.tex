...
Adopting the idealized view in \cite{Deutsch_1955} of stars as sharply bound and uniformly magnetized spheres, one finds
...
\begin{equation*}
	L = \frac{2\mu^2 \omega^4 \kern-1.0pt \sin^2 \kern-2.0pt \chi}{3c^3}
\end{equation*}
is the exact expression for radiant power, derived by many standard sources like \cite{Jackson_1999} as well. A static angle
...
\begin{equation*}
	...
	\raisebox{-0.15ex}{\( 1 + \sin^2 \kern-2.0pt \chi \kern+1.0pt \)} \bigr) \)} }{c^3}
\end{equation*}
