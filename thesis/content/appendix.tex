...
suggested. Since the simplicity offered by \eqref{eqn:ratio} more than compensates for the absence of $\mathscr{A} = 1/3$
coefficients in the context of this work, the function defined by $\mathscr{A} = 1/2 \kern+0.2pt$ in table \ref{tab:hadron-ratio}
is used for all calculation where it is relevant.
