...
\end{equation*}
for the integrated spectrum. Accordingly, one finds
\begin{equation*}
	\frac{dN}{dE} = \frac{N_0}{E_0} \left( \frac{E}{E_0} \right)^\alpha
\end{equation*}
as the differential spectrum where
\begin{equation*}
	\alpha = \frac{\ln(\varsigma)}{\ln(f)} - 1
\end{equation*}
defines the spectral index. From $\varsigma < 1$ and $\eta > 1$ follows $\alpha + 1 < 0$
