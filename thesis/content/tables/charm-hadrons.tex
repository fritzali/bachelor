\begin{table}[H]
	...
	\caption[Coefficients for charm hadron production, cooling and decay.]{Coefficients for charm hadron production,
			 ...
			 via the fragmentation function in \cite{Kniehl_2006} with normalizations $N_h$ given by \cite{Carpio_2020} to rescale
			 ...
			 listings. For mass type quantities, natural units $c = 1$ are used.}
