\begin{table}[H]
	\centering
	\vspace{2.0ex}
	\caption[Fits to the total cross sections $\sigma_{h \kern-0.1pt p}$ in hadron-{\kern+0.1pt}proton collisions.]
			{Fits to the total inclusive scattering cross sections
			 in hadron-{\kern+0.1pt}proton collisions. Parameters are taken from \cite{Belousov_2016} with
