...
corresponding to roughly \qty{100}{\astronomicalunit} taken from \cite{King_2008}. Typical number densities are of the order
\qty{e15}{\per\centi\meter\cubed} in the disk plane \cite{Garcia_2013, Garcia_2014} and are taken to be
$n = \kern-0.5pt \smash{\qty{e14}{\per\centi\meter\cubed}}$ for the following calculations to account for
the reduction at larger heights. 





As a comparison to the scales of other AGN features, typical SMBH masses of \qty{e8}{\solarmass} roughly
correspond to a \qty{2}{\astronomicalunit} Schwarzschild radius. Accretion disks reach \qty{10}{\milli\parsec} 





\eqref{eqn:ejecta-radius}

as well as an effective optical depth are included via multiplication.
