...
With the present parameters, our model predicts number densities of $n_\text{ej} = \qty{3.1e18}{\per\centi\meter\cubed}$ after one spindown
time $t_\text{sd} = \smash{\qty{3.2e3}{\second}}$ has passed.
