...
maximum charm fluence, one can infer a power law as the underlying proton spectrum, which is only slightly modified by the cross
section \eqref{eqn:hpr1r2} slowly increasing with energy.
